...
/// </summary>
namespace Core.Business.DataAccess.DataAccessLayer.General
{
    public static class Conversion
    {
        ...
        public static double StringToDouble(string number, int precision)
        {
            ...
            {
                Log.Write("Getconvertion class", "StringToDouble", ex.Source, ex.Message);
                return 0;
            }
        }
        ...
        public static string CurrencyToWord(string MyNumber, string orginalNumber)
        {
            ...
            {
                Log.Write("Convertion to Word", "CurrencyToWord", ex.Source, ex.Message);
        ...
        private static string ConvertHundreds(string MyNumber)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Write("Convertion to Word", "ConvertHundreds", ex.Source, ex.Message);
                return "error - not converted!";
            }
        }
        ...
        private static string ConvertTens(string MyTens)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Write("Convertion to Word", "ConvertTens", ex.Source, ex.Message);
                return "error - not converted!";
            }
        }
        ...
        private static string ConvertDigit(string MyDigit)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.Write("Convertion to Word", "ConvertDigit", ex.Source, ex.Message);
                return "error - not converted!";
            }
        }
