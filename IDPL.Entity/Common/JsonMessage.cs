...
namespace Core.Entity.Common
{
    ...
    public class JsonMessage<T>
    {
        ...
        /// <summary>
        /// Use This Constructor when you Want To Return Error Message
        /// </summary>
        /// <param name="isSuccess">success flag</param>
        /// <param name="messageCaption">Popups Caption Text</param>
        /// <param name="message">Message To Show Inside Popup</param>
        /// <param name="jsonMessageType">This Defines Header Color Of The Popup</param>
        /// <param name="data">Dynamic Object</param>
        public JsonMessage(bool isSuccess, string messageCaption, string message, KeyEnums.JsonMessageType jsonMessageType, string errorMessage, T data)
            : this(isSuccess, messageCaption, message, jsonMessageType)
        {
        ...
        /// <param name="jsonMessageType">This Defines Header Color Of The Popup</param>
        /// <param name="data">Dynamic Object</param>
        public JsonMessage(bool isSuccess, string messageCaption, string message, KeyEnums.JsonMessageType jsonMessageType, T data)
            : this(isSuccess, messageCaption, message, jsonMessageType)
        {
            this.Data = data;
        }
        ...
        /// <param name="flag">Additional string Value For Client Side Processing</param>
        /// <param name="data">Dynamic Object</param>
        public JsonMessage(bool isSuccess, string messageCaption, string message, KeyEnums.JsonMessageType jsonMessageType, string returnUrl, string flag, T data)
            : this(isSuccess, messageCaption, message, jsonMessageType, returnUrl, flag)
        {
            this.Data = data;
        }
